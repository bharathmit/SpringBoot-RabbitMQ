(function () {
    function a(a) {
        var b = a.source, d = a.target, e = c(b, d), f = [b];
    ...
    function c(a, c) {
        if (a === c)return a;
        var d = b(a), e = b(c), f = d.pop(), g = e.pop(), h = null;
        ...
        if (f > 1) {
            ...
            if (f > 2) {
                ...
                for (var m = 3; m < f; m++) {
                    O(g, h, i = a[m]);
                    var n = 0, o = 1, p = 1;
                    for (j = h._pack_next; j !== h; j = j._pack_next, o++)if (I(j, i)) {
                        n = 1;
                        break
                    }
    ...
    d3.layout = {}, d3.layout.bundle = function () {
        ...
        function B() {
            var a = v.length, d = w.length, e, f, g, h, i, j, l, m, p;
            for (f = 0; f < d; ++f) {
            ...
            return b.tick({type: "tick", alpha: n}), (n *= .99) < .005
        }
        ...
        var a = {}, b = d3.dispatch("tick"), c = [1, 1], d, n, o = .9, p = l, q = m, r = -30, s = .1, t = .8, u, v = [], w = [], x, y, z;
        return a.on = function (c, d) {
            ...
            var b, d, e = v.length, f = w.length, g = c[0], h = c[1], i, j;
            ...
            z = [];
            if (typeof r == "function")for (b = 0; b < e; ++b)z[b] = +r.call(this, v[b], b); else for (b = 0; b < e; ++b)z[b] = r;
            return a.resume()
        }, a.resume = function () {
    ...
    d3.layout.partition = function () {
        ...
        var a = Number, b = n, c = 0, e = 2 * Math.PI;
    ...
    d3.layout.stack = function () {
        ...
        var a = Object, b = r["default"], c = s.zero, d = q, e = o, f = p;
    ...
    var r = {
        "inside-out": function (a) {
            var b = a.length, c, d, e = a.map(t), f = a.map(u), g = d3.range(b).sort(function (a, b) {
                return e[a] - e[b]
            }), h = 0, i = 0, j = [], k = [];
    ...
    d3.layout.histogram = function () {
        ...
        function e(f, h, i) {
            var j = b.call(g, f, h), k = E ? f : {data: f};
            k.depth = h, i.push(k);
            if (j && (m = j.length)) {
    ...
    d3.layout.pack = function () {
        ...
        var a = d3.layout.hierarchy().sort(F), b = [1, 1];
        ...
        function d(d, e) {
            ...
            var l = R(g), m = S(g), n = l.x - b(l, m) / 2, o = m.x + b(m, l) / 2;
            return $(g, function (a) {
                a.x = (a.x - n) / (o - n) * c[0], a.y = (1 - a.y / g.y) * c[1]
            }), f
        }

        var a = d3.layout.hierarchy().sort(null).value(null), b = T, c = [1, 1];
        ...
        function d(d, e) {
            ...
            var k = W(g, Y), l = W(g, X), m = W(g, Z), n = k.x - b(k, l) / 2, o = l.x + b(l, k) / 2, p = m.depth || 1;
            return $(g, function (a) {
        ...
        var a = d3.layout.hierarchy(), b = Math.round, c = [1, 1], d = null, e = bc, f = !1, g, h = .5 * (1 + Math.sqrt(5));
