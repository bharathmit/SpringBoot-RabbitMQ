...
import static com.cablePaypal.springpaypal.PaymentIntent.authorize;
import static com.cablePaypal.springpaypal.PaymentMethod.credit_card;
import static com.cablePaypal.springpaypal.builders.Builders.*;
...
public class PayPalRestTemplateTest {
    ...
    private Payment createPayment(){
        CreditCard creditCard = creditCardBuilder()
                .type("visa").number("4311197314219346")
                .expireMonth(04).expireYear(2021)
